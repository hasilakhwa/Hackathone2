...
A simple command-line todo application that stores tasks in memory. This application allows users to add, view, update, delete, and mark tasks as complete through an interactive console interface.
...
Run the application with: `python -m src.todo_app.main`

Or if installed as a package: `todo-app`
